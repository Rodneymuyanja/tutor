...
public class artsTutor extends Tutor {
    /**
    ...
    public String confirmCompletion(String sessionID, String studentID) throws AWTException {
        Session session = new Session("12:00", 3, new Subject("physics", 56, 4.9), new Student("rodney", "45"),
                new Tutor(), "Acacia", 45);
        
                
        try {
            if(session.timer() == true){
                  session.catchBreach();
                  session.showTray();
            }
